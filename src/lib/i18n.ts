...
const ZH_CN_MESSAGES = {
  ...
  "WeCom returned an invalid status response.": "企业微信返回的状态响应无效。",
  "WeCom is configured but not online.": "企业微信已配置但当前不在线。",
  "WeCom is disabled.": "企业微信已停用。",
  "WeCom is not configured yet.": "企业微信尚未配置。",
  "WeCom is online. Send a private message to the bot to test the AI reply.": "企业微信已在线。请向机器人发送一条私聊消息测试 AI 回复。",
  ...
  "Configure your AI provider first. WeCom setup unlocks after AI credentials are saved.": "请先配置 AI 服务商。保存 AI 凭据后即可设置企业微信。",
  "WeCom Bot ID": "企业微信 Bot ID",
  "WeCom Secret": "企业微信 Secret",
  "Enable WeCom": "启用企业微信",
  "Failed to save WeCom settings.": "保存企业微信设置失败。",
  "WeCom settings saved. Check status to confirm the WebSocket channel is online.": "企业微信设置已保存。请检查状态以确认 WebSocket 通道已上线。",
  "WeCom is disabled. Your saved credentials are retained.": "企业微信已停用。已保存的凭据会保留。",
  "Use the WeCom smart bot to send a private message. It should reply through the configured AI provider; no separate ClawBox pairing approval is required.": "请使用企业微信智能机器人发送一条私聊消息。机器人应通过已配置的 AI 服务商回复；无需单独在 ClawBox 中批准配对。",
  "Never commit WeCom Bot ID or Secret to GitHub or include them in screenshots or chat messages.": "不要将企业微信 Bot ID 或 Secret 提交到 GitHub，也不要放入截图或聊天消息。",
  "How to configure a WeCom bot": "如何配置企业微信机器人",
  "WeCom step 1": "先在运行 OpenClaw 的设备上安装企业微信 OpenClaw 官方插件",
  "WeCom step 2": "按照企业微信智能机器人文档创建机器人",
