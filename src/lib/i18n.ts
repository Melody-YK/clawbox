...
const ZH_CN_MESSAGES = {
  ...
  "Update request received. Waiting for the update service...": "已收到更新请求，正在等待更新服务...",
  "An update is already in progress.": "已有更新正在进行中。",
  "The update service is restarting. Waiting for it to come back online...": "更新服务正在重启，等待服务恢复...",
  "Update status response was invalid.": "更新状态响应无效。",
  ...
  "Login is starting. The page will check again shortly.": "登录正在启动，页面稍后会再次检查。",
  "Login is still starting. The page will check again shortly.": "登录仍在启动，页面稍后会再次检查。",
  "WeChat QR login session expired.": "微信二维码登录会话已过期，请重新生成二维码。",
  "WeChat QR login session not found.": "微信二维码登录会话不存在或已失效。",
