...
export default function WifiStep({
  ...
  const connectWifi = async () => {
    ...
    try {
      ...
      const serverMessage =
        okData?.message ||
        `Settings saved. The hotspot will disconnect shortly while the device joins your Wi‑Fi. After your phone reconnects to the same Wi‑Fi, this page will provide a direct “Open Device” button with the full reachable address.`;
